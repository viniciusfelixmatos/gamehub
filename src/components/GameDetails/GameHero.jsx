...
// Importação do ícone de seta para a esquerda do React Icons
  ...
  return (
    <div className="relative w-full h-[40vh] md:h-[60vh] overflow-hidden bg-bg-element">
      ...
      <div className="absolute bottom-0 left-0 right-0 max-w-7xl mx-auto px-4 pb-6 md:pb-12">
        ...
        >
          <BsArrowLeft className="text-base transform group-hover:-translate-x-1 transition-transform duration-300" />
          <span>Voltar</span>
        </button>
