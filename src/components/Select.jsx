...
export function Select({ options, placeholder, defaultValue, onValueChange }) {
  return (
    ...
    >
      ...
      <SelectPrimitive.Trigger className="inline-flex items-center justify-between gap-3 bg-bg-element border border-border-focus text-zinc-200 text-sm rounded-lg px-4 py-2 min-w-50 focus:outline-none focus:border-brand-primary cursor-pointer font-primary transition-colors data-placeholder:text-zinc-500">
      ...
      <SelectPrimitive.Portal>
        <SelectPrimitive.Content className="overflow-hidden bg-bg-surface border border-border-subtle rounded-lg shadow-xl animate-in fade-in-50 duration-100 z-[3] min-w-50">
